      ...
      function(data, menu)
        ...
        if data.current.value == 'teleport_marker' then
          ...
          if DoesBlipExist(WaypointHandle) then
            ...
            exports.pNotify:SendNotification({text = "Uspesno ste se teleportovali do lokacije koj ste zeleli", type = "success", timeout = 2000, layout = "center", queue = "right"})
          else
